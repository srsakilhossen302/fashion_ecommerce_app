...
class BlogGridFashionDetailsPage extends StatefulWidget {
  final String image;
  final String title;
  final String description;
  final String date;

  const BlogGridFashionDetailsPage({
    super.key,
    required this.image,
    required this.title,
  ...
  @override
  State<BlogGridFashionDetailsPage> createState() => _BlogGridFashionDetailsPageState();
}

class _BlogGridFashionDetailsPageState extends State<BlogGridFashionDetailsPage> {
