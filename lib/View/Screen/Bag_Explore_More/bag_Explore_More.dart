...
class BagExploreMore extends StatefulWidget {
  const BagExploreMore({super.key});

  @override
  State<BagExploreMore> createState() => _BagExploreMoreState();
}

class _BagExploreMoreState extends State<BagExploreMore> {
  int selectedIndex = 0;
