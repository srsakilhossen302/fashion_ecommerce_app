...
class AllExploreMore extends StatefulWidget {
  const AllExploreMore({super.key});

  @override
  State<AllExploreMore> createState() => _AllExploreMoreState();
}

class _AllExploreMoreState extends State<AllExploreMore> {
  int selectedIndex = 0;
